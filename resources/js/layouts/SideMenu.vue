<template>
    <div class="p-0">
        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            <nav
                class="side-nav bg-primary pr-5 pb-16 overflow-x-hidden hidden md:block w-[85px] xl:w-[230px]"
            >
                <RouterLink
...
<!--                        :src="logoUrl"-->
<!--                    />-->
                    <span class="hidden ml-3 text-lg text-white xl:block"> Breathrise </span>
                </RouterLink>
...
import logoUrl from "../../../public/images/dondogmaa.png";
