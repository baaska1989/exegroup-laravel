<template>
    <footer style="background-color: #0e1447">
    <div class="bg-darkblue font-bold">
        <div
            class="bg-darkblue grid gap-0 sm:grid-cols-2 md:grid-cols-7 lg:grid-cols-10 w-full p-4 md:p-12 text-xs md:text-base"
        >
            <div
                ...
                <ul class="text-gray-300 pl-4 list-none w-full">
                    <div class="flex">
                        ...
                        <li class="font-bold text-base">
                            <font style="vertical-align: inherit"
                                ><font style="vertical-align: inherit"
                                    >5th floor, Quatre Saison Kojimachi, 4-8-19
                                    Kojimachi, Chiyoda-ku, Tokyo 102-0083</font
                                ></font
                            >
                        </li>
                    </div>
                    <div class="flex mt-5">
                        ...
                        <li class="font-bold text-base">(81) 3-3288-2371</li>
                    </div>
                    <div class="flex mt-5">
                        <svg
                            width="24"
        ...
        >
            <font style="vertical-align: inherit"
                ><font style="vertical-align: inherit"
                    >Copyright © 2022 EXE Co., Ltd. All Rights Reserved..</font
                ></font
            >
        </div>
    </div>
