<template>
    ...
    <div class="flex flex-col mx-auto max-w-6xl">
        ...
        <div class="px-4">
            <div class="border-solid border-2 border-[#a7adaf] rounded-[24px]">
                <div class="flex flex-col md:flex-row justify-center">
                    <div>
                        <div class="md:text-2xl font-bold text-gray-700">
                            <h2
                        ...
                        <div class="flex">
                            <img
                                ...
                                class="h-48 w-auto mx-auto hidden md:block"
                                loading="lazy"
                            />
                            <div
                ...
                <img
                    ...
                    class="h-12 w-[800px] mx-auto"
                    loading="lazy"
                /><img
                    src="/assets/img/text_box-1.png"
                    class="h-42 w-[800px] mx-auto p-2"
                    loading="lazy"
                />
                <div class="py-8">
        ...
        <div class="max-w-6xl px-4">
            ...
            <div class="flex flex-col-reverse md:flex-row">
                ...
                <img
                    ...
                    class="p-5 lg:mt-8 h-52 mx-auto border-solid border-2 border-[#92ACDD] rounded-full md:p-4 align-middle"
                    loading="lazy"
                />
            </div>
            <div class="flex flex-col-reverse md:flex-row mt-4 py-4">
                <p
                ...
                <img
                    ...
                    class="p-5 lg:mt-8 h-52 mt-0 mx-auto border-solid border-2 border-[#92ACDD] rounded-full md:p-4 align-middle"
                    loading="lazy"
                />
            </div>
        ...
        <div class="items-center text-center">
            <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSddgYtieThncUj6lXwjolR6aRRCVLUjdG63GqD7Teo7uwjXvA/viewform"
                ><button
                    class="inline-block px-20 py-5 m-10 bg-[#4473CA] text-white font-extrabold text-2xl rounded-lg leading-snug uppercase focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                    role="button"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex basis-1/3">
                <div
                    class="grid md:ml-0 sm:px-4 lg:px-0 px-4"
                    style="width: 100%"
                >
                    <div
                    ...
                    <div
                        class="items-center divide-gray-500 grid grid-cols-7 divide-x-2 md:ml-5 border-t-2 border-r-2 border-l-2 border-gray-500"
                    >
                        <div
                            class="col-span-1 text-center font-medium m-3 text-gray-500"
                        >
                            1
                        </div>
                    ...
                    <div
                        class="divide-gray-500 grid grid-cols-7 divide-x-2 md:ml-5 border-t-2 border-r-2 border-l-2 border-gray-500"
                    >
                        <div class="text-center font-medium m-3 text-gray-500">
                            3
                        </div>
                    ...
                    <div
                        class="divide-gray-500 grid grid-cols-7 divide-x-2 md:ml-5 border-2 border-gray-500"
                    >
                        <div class="text-center font-medium m-3 text-gray-500">
                            14
                        </div>
            ...
            <div class="">
                <div class="mb-5 m-4 lg:my-0 pt-0">
                    <div
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex basis-1/3">
                <div class="grid md:ml-0 lg:py-4 lg:px-0 px-4 w-full">
                    <div
                        class="divide-gray-500 grid grid-cols-7 divide-x-2 md:ml-5 border-t-2 border-r-2 border-l-2 bg-darkblue border-gray-500"
                    >
            ...
            <div class="">
                <div class="mb-1 p-4" style="margin-right: 0px">
                    <div
                        class="items-center divide-gray-500 grid grid-cols-3 divide-x-2 border-t-2 border-r-2 border-l-2 border-gray-500"
                    >
                        <div class="text-center font-medium m-3 text-gray-500">
            ...
            <div class="border-2 border-gray-300 rounded-xl mt-5">
                ...
                <div class="flex">
                    <svg
                        ...
                        viewBox="0 0 32 32"
                        class="ml-5 mb-5 w-20 h-20 fill-current text-gray-700"
                    >
                        <path
                ...
                <div
                    class="md:flex md:flex-row-reverse grid grid-cols-1 md:grid-cols-2"
                >
                    <p
                    ...
                    <img
                        ...
                        class="w-[100%] md:w-[50%] h-auto mx-auto md:px-10 px-4"
                        loading="lazy"
                    />
                </div>
                <div class="flex">
                    <img
                        ...
                        class="h-20 w-20 m-8 fill-current text-gray-700"
                        loading="lazy"
                    />
                    <p
        ...
        <div class="md:px-4 mt-4">
            ...
            <div class="md:flex grid grid-cols-1 md:grid-cols-2">
                <img
                    src="/assets/img/team/1660885866.png"
                    class="h-[200px] w-[200px] m-auto md:ml-8"
                    loading="lazy"
                />
                <div>
                    <h3
            ...
            <div class="md:flex grid grid-cols-1 md:grid-cols-2 mt-4">
                <img
                    src="/assets/img/team/1660884961.png"
                    class="md:ml-8 h-[200px] w-[200px] m-auto"
                    loading="lazy"
                />
                <div>
                    <h3
            ...
            <div class="md:flex grid grid-cols-1 md:grid-cols-2 mt-4">
                <img
                    ...
                    class="md:ml-8 h-[205px] w-[205px] m-auto"
                    loading="lazy"
                />
                <div>
                    <h3
            ...
            <div class="md:flex grid grid-cols-1 md:grid-cols-2 mt-4">
                <img
                    ...
                    class="md:ml-8 h-[215px] w-[215px] m-auto"
                    loading="lazy"
                />
                <div>
                    <h3
        ...
        <div>
            ...
            <div class="items-center text-center">
                <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSddgYtieThncUj6lXwjolR6aRRCVLUjdG63GqD7Teo7uwjXvA/viewform?usp=send_form"
                    ><button
                        class="inline-block px-20 py-5 m-10 bg-[#4473CA] text-white font-extrabold text-2xl rounded-lg leading-snug uppercase focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                        role="button"
                        data-mdb-ripple="true"
