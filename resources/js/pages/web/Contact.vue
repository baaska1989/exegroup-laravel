            ...
            <section class="mb-32 text-center text-gray-700">
                <div class="max-w-[800px] mx-auto px-3">
                    <div class="flex mt-4 justify-center">
                        ...
                        <li class="font-bold">(81) 3-3288-2371</li>
                    </div>
                    <div class="flex mt-4 justify-center">
                        <svg
                            width="24"
                    ...
                    <form>
                        ...
                        <button
                            type="submit"
                            class="w-full px-6 py-2.5 bg-darkblue text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                        >
                            Send
                        </button>
                    </form>
