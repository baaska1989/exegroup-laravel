            ...
            <div class="block grid-cols-2 gap-4 xl:grid">
                ...
                <div class="flex-col hidden min-h-screen xl:flex">
                    <a href="" class="flex items-center pt-5 -intro-x">
                        ...
                        <!--                            :src="logoUrl"-->
                        <!--                        />-->
                        <span v-for="user in users">{{ user.first_name }}</span>
                ...
                <div class="flex h-screen py-5 my-10 xl:h-auto xl:py-0 xl:my-0">
                    ...
                    >
                        ...
                        <form v-on:submit="login">
                            <div
                                v-for="msg in auth_error_messages"
                                :key="msg.id"
                                role="alert"
                                aria-live="polite"
                                aria-atomic="true"
                            ...
                            <div class="mt-8 intro-x">
                                <input
                                    v-model="email"
                                    type="text"
                                    class="block px-4 py-3 rounded intro-x input-sm login__input min-w-full xl:min-w-[350px]"
                                    placeholder="Email"
                                    required
                                />
                                <input
                                    v-model="password"
                                    type="password"
                                    class="block px-4 rounded py-3 mt-4 intro-x login__input min-w-full xl:min-w-[350px]"
                            ...
                            >
                                <button
                                    type="submit"
                                    class="w-full rounded px-4 py-3 align-top xl:w-32 xl:mr-3 text-white bg-blue-500 hover:bg-blue-400"
                                >
                                    Login
                                </button>
                            </div>
...
export default {
    ...
    computed: {
        ...mapGetters(["auth_error_messages"]),
    },
};
</script>
